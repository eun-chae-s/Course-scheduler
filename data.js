...
function getPDF(){
  var doc = new jsPDF();
  var fallHTML = $('.fall-schedule').html();
  ...
  doc.addPage();
  var winterHTML = $('.winter-schedule').html();
  doc.fromHTML(winterHTML, 15, 15, {
    'width': 500,
    'height': 600,
    'elementHandlers': specialElementHandlers
  })

  doc.save('sampel-document.pdf');
